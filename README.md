...
Try our [AI Assistant on ChatGPT](https://chatgpt.com/g/g-6882e23ee3e881918f5f27140c66f28b-arbe-l-index)
---
...
| ------------------------------------- | --------------------------------------------------- |
| `arbe_lambda_demo.ipynb`              | Jupyter notebook demonstrating λ\* analysis         |
| `arbe_lambda_colab_demo_clean.ipynb`  | Colab-ready notebook for interactive exploration    |
| `demo_lambda_star.png`                | Demo plot image generated by script                 |
| `arbe_lambda_full_export`             | Full dataset (\~13,283 HLC colours with λ\* and Rλ) |
| `paper_md_joss.txt`                   | JOSS submission manuscript                          |
